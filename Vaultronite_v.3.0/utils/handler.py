...
def create_db(db_file: str) -> None:
    ...
    try:
        ...
        if no_of_pwds == 0:
            ...
            cursor.execute(
                f"INSERT INTO entries(pid, vid, site, esp, username) VALUES(1, 1, 'site', '{esp}', 'testusername')"
            )
        conn.commit()
...
def add_entry_to_db(db_file: str, vmp: str, vid: int, site: str, pwd: str, username: str) -> None:
    ...
    # Use placeholders in the SQL query to avoid SQL injection attacks
    query = "INSERT INTO entries(vid, site, esp, username) VALUES(?, ?, ?, ?)"
    values = (vid, site, esp, username)
