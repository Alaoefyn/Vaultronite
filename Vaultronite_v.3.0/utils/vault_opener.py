...
class GivePswEntry(ct.CTkToplevel):
    pwd_error = False
    vault_window = None
    win_height = 150
    win_width = 400
    ...
    def __init__(self, db_file: str, vault: tuple, *args, **kwargs):
        ...
        self.enter_pwd_frame = ct.CTkFrame(self, fg_color="transparent")
        ...
        self.enter_pwd_label = ct.CTkLabel(
        ...
        self.enter_pwd_entry = ct.CTkEntry(self.enter_pwd_frame, show="●")
        ...
        self.open_vault_button = ct.CTkButton(
            self.buttons_frame,
            text="Open Vault",
